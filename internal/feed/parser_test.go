...
func TestSpamhausRejectsMetadataRecordMismatch(t *testing.T) {
	body := "{\"type\":\"metadata\",\"timestamp\":1784246400,\"copyright\":\"copyright\",\"terms\":\"https://example.invalid/terms\",\"records\":2}\n{\"cidr\":\"8.8.8.0/24\"}\n"
	_, err := Parse(FormatSpamhausDROPJSONL, stringsReader(body), defaultLimits(FamilyIPv4))
